...
First install [numlib](https://github.com/sj-simmons/numlib), and then read on.
...
meanwhile, general usage notes are available on the front page of  numlib's [repo](https://github.com/sj-simmons/numlib).
